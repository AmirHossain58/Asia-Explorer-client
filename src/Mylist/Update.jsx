...
const Update = () => {
  ...
  const handleUpdateSpot = (event) => {
    ...
    fetch(
      `https://b9-a10-asia-explorer-server.vercel.app/TouristsSpot/${_id}`,
      {
        method: "PUT",
        headers: {
    ...
    <div>
      ...
      <div className="card container mx-auto my-12 shrink-0 w-full shadow-2xl ">
        <div className="text-center max-w-[900px] mx-auto">
          <h1 className="text-4xl mt-12 font-bold">Update Tourists Spot</h1>
          <br />
          <p>
            Update Tourist Spot: Customize and refine your travel destinations
            with ease. Update details, adjust descriptions, and keep your list
            current for unforgettable adventures.
          </p>
        </div>
        <form onSubmit={handleUpdateSpot} className="card-body">
          ...
          <div className="form-control mt-6">
            <button className="btn bg-green-300 font-bold">
              Add Tourists Spot
            </button>
          </div>
        </form>
